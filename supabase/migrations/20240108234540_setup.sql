...
AS $$
DECLARE
  project_url TEXT := 'https://awwrsiduehwomcuulkpk.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImF3d3JzaWR1ZWh3b21jdXVsa3BrIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxMDkxNzI3MywiZXhwIjoyMDI2NDkzMjczfQ.sc1VEPjRIBoTnsQinqv5Bss1vkW2r6eX_iSRs7j9H0U'; -- full access needed for http request to storage
